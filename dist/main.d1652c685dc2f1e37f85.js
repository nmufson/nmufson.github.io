...
/* harmony export */   populateAutoComplete: () => (/* binding */ populateAutoComplete)
/* harmony export */ });
...
const populateAutoComplete = async (string) => {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    newListItem.addEventListener('click', () => {
      ...
      (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.loadPage)(location);
    });
...
const createListItem = (city,region,country) => {
...
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/getHours.mjs");
...
const domManipulation = () => {
  ...
  const searchDiv = () => {
    ...
    input.addEventListener('input', () => {
      (0,_autocomplete_js__WEBPACK_IMPORTED_MODULE_1__.populateAutoComplete)(input.value);
    });
  ...
  const currentWeather = async (weatherObj) => { 
  ...
  const hourlyForecast = (weatherObj) => {
    ...
    const now = new Date();
    const nextimetHour = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.getHours)(now) + 1;
  ...
  const dailyForecast = (weatherObj) => {
    ...
    const tomorrow = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.addDays)(today, 1);
    const nextDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.addDays)(today, 2);
    const tomorrowName = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(tomorrow, 'EEEE');
    const nextDayName = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(nextDay, 'EEEE');
  ...
  return {searchDiv, currentWeather, hourlyForecast, dailyForecast}
...
const loadPage = async (city) => {
  ...
  try {
    const weatherObj = await (0,_fetch_weather__WEBPACK_IMPORTED_MODULE_1__.getWeather)(city).processWeatherData(city);
    mainContainer.innerHTML = '';
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.domManipulation)().searchDiv();
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.domManipulation)().currentWeather(weatherObj);
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.domManipulation)().hourlyForecast(weatherObj);
    (0,_dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.domManipulation)().dailyForecast(weatherObj);
